...
** Make sure I don't screw up lines.
...
*** Keybindings for Markdown                                            :key:

(Really need to reorg this.  Not sure that I can define keys before bringing in the mode tho...)
...
*** De-uglify markdown line-breaks
