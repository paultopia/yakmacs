...
Ok, this is weird.  I'm going to try to get completions going and also see if black works in the virtualenv, if so, then maybe I'll work on completions more.  
