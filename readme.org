...
**** Fix the todo cycle binding that doesn't work 

if this works I should be able to do comma then t to cycle todo
...
** DONE some evil-org keybindings don't work.
