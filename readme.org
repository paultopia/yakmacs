...
because I don't *think* anything else uses ampersand...?

The annoying price for this strategy is that it keeps yelling at me on startup about using 
potentially unsafe file-local-variables.  I give it the exclamation mark, and then it accepts that... 
for a while, but then seems to forget (maybe when I change this file?)
