...
* Javascript (and vue, html, etc. all the web shit)

All this stuff sucks.  It's making my emacs slow down horribly and I hate it.  Need to clear off the garbage (probably js2 and web-mode).  It's horrible. 
...
** TODO add keybindings for json-mode

see functionality [[https://github.com/joshwnj/json-mode/][here]]
